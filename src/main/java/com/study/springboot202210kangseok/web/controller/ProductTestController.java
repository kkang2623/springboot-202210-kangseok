...
public class ProductTestController {
    ...
    @GetMapping("/templates/product/addition")
    public String loadAdditions() {
        return "templates/product/product_add";
    }
...
//--------------------------↓ProductDto 객체로 담아서 ↓---------------------------------------
    ...
    public String registerProduct(Model model, ProductDto productDto) {  //객체 형태로 넘어온다
        ...
        return "templates/product/product_view";
    }

    @GetMapping("/templates/product/addition2")
    public String loadAddition2(){
        return "templates/product/product_add2";
    }
